...
#include "DataCenterReservationListParser.h"

DataCenterReservationListParser::DataCenterReservationListParser(const char *s) : DataCenterListParser(s) {
    // TODO Auto-generated constructor stub

}

DataCenterReservationListParser::~DataCenterReservationListParser() {
    // TODO Auto-generated destructor stub
}

int DataCenterReservationListParser::parse() {
        ...
        while ((tokenizer.hasMoreTokens()) && (currentDataCenter < numDataCenters) && (result==SC_OK)){
            ...
            if ((tokenizer.hasMoreTokens()) && (result==SC_OK)){
              ...
              EV_ERROR << "Cannot read number of reserved nodes of the Data-Center:" << currentDataCenter << endl;
              result = SC_ERROR;
            }
            ...
            if (result==SC_OK){
                ...
                dataCenterReservationObj = new DataCenterReservation (dataCenterNameStr, nReservedNodes);
                ...
                while ((tokenizer.hasMoreTokens()) && (currentRack < numComputingRacks) && (result==SC_OK)){
                    ...
                    // Generate Racks and include them in the Data-Center object!
                        ...
                        for (currentRackInstance = 0; currentRackInstance < numRackInstances; currentRackInstance++){
                            ...
                            dataCenterReservationObj->addRack(rack, false);
                        }
                ...
                while ((tokenizer.hasMoreTokens()) && (currentRack < numStorageRacks) && (result==SC_OK)){
                    ...
                    // Generate Racks and include them in the Data-Center object!
                        ...
                        for (currentRackInstance = 0; currentRackInstance < numRackInstances; currentRackInstance++){
                            ...
                            // Add current rack to the data-center
                            dataCenterReservationObj->addRack(rack, true);
                        }
            ...
            parseResult.push_back(dataCenterReservationObj);
