...
#include "UserPriorityListParser.h"

UserPriorityListParser::UserPriorityListParser(const char *s, std::vector<VirtualMachine*> *vmTypesVector, std::vector<Application*> *appTypesVector, std::vector<Sla*> *slaTypesVector) : UserListParser(s, vmTypesVector, appTypesVector) {
    slaTypes = slaTypesVector;
}

UserPriorityListParser::~UserPriorityListParser() {
    // TODO Auto-generated destructor stub
}

int UserPriorityListParser::parse() {
...
Sla* UserPriorityListParser::findSla (std::string slaType){
